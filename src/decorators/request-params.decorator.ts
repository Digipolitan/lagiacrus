...
export const Body = RouteParametersUtils.createDecorator((ctx: RouterContext, options?: IParameterDecoratorOptions | string): Promise<any> => {
    return RouteParametersUtils.defaultDecoratorHandler(ctx, ctx.request['body'], options);
});

export const Query = RouteParametersUtils.createDecorator((ctx: RouterContext, options?: IParameterDecoratorOptions | string): Promise<any> => {
    return RouteParametersUtils.defaultDecoratorHandler(ctx, ctx.request.query, options);
});

export const Headers = RouteParametersUtils.createDecorator((ctx: RouterContext, options?: IParameterDecoratorOptions | string): Promise<any> => {
    return RouteParametersUtils.defaultDecoratorHandler(ctx, ctx.request.headers, options);
});

export const Params = RouteParametersUtils.createDecorator((ctx: RouterContext, options?: IParameterDecoratorOptions | string): Promise<any> => {
    return RouteParametersUtils.defaultDecoratorHandler(ctx, ctx.params, options);
});

export const State = RouteParametersUtils.createDecorator((ctx: RouterContext, options?: IParameterDecoratorOptions | string): Promise<any> => {
